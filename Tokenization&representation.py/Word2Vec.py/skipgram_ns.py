"""We build this word2vec model on the dataset of fifty thousand tokens and it showed us quite good result atleast with this much limited dataset we use the skip-gram negative sampling where we are trying to 
   predict the context words from center word"""
